...
module.exports = function graphql(cfg) {
  ...
  return function(req, res, next) {
    ...
    const query = req.params.query || params.query;
    const operationName = req.params.operationName || params.operationName;
    const variables = getVariables(
      req.params.variables || params.variables,
      res
    );
    ...
    if (showGraphiQL) {
      ...
      res.setHeader("Content-Length", Buffer.byteLength(resultjs, "utf8"));
      res.write(resultjs);
      res.end();
    ...
    function handleRequest() {
      ...
      const validationErrors = gql.validate(
        schema,
        documentAST,
